...
ref$barcodei %>% write(gzfile('~/git/scEiaD_modeling/data/hs111_dev_eye_ref_bcs.full.20250225.stage4.csv.gz'))
query$barcodei %>% write(gzfile('~/git/scEiaD_modeling/data/hs111_dev_eye_query_bcs.full.20250225.stage4.csv.gz'))

nobs %>% dplyr::rename(barcode = barcodei) %>% write_csv('~/git/scEiaD_modeling/data/Human_Developing_Eye__stage4_CTcalls.freeze20250225.01.csv.gz')
```
...
python ~/git/scEiaD_modeling/workflow/scripts/append_obs.py ../hs111.adata.solo.20250204.dev.h5ad /home/mcgaugheyd/git/scEiaD_modeling/data/Human_Developing_Eye__stage4_CTcalls.freeze20250225.01.csv.gz  hs111.adata.solo.20250225.dev.stage4CT.h5ad --transfer_columns MajorCellType,CT
...
```{r}
obs_stage4 <- pull_obs('~/data/scEiaD_modeling/hs111_developing_eye/stage4/hs111_dev_eye_stage4_20250225_2000hvg_200e_50l.obs.csv.gz', machine_label = 'scanvi_CT', label = 'CT')
```
